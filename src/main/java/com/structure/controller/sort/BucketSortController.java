...
import com.structure.sort.BucketSort;
...
@Controller
@RequestMapping("/sort")
public class BucketSortController extends NormalController {
	/** ソート名 */
	private final static String SORT_NAME = "Bucket Sort";
	...
	public void sort() {
		super.sort();
		bucketSort.sort(sortModel.getSortedList(), true);
