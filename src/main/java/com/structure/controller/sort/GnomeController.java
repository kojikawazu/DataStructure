...
import com.structure.sort.GnomeSort;
...
@Controller
@RequestMapping("/sort")
public class GnomeController extends NormalController {

	/** ソート名 */
	private final static String SORT_NAME = "Gnome Sort";
	...
	public void sort() {
		super.sort();
		gnomeSort.sort(sortModel.getSortedList(), false);
